...
namespace Smart_ELearning.Data.Initializer
{
    public class DbInitializer : IDbInitializer
    {
        ...
        public DbInitializer(ApplicationDbContext db, UserManager<AppUserModel> userManager,
        ...
        public void Initialize()
        {
            ...
            if (_userManager.FindByEmailAsync("admin@elearning.com").Result == null)
            {
                ...
                var result = _userManager.CreateAsync(user, "Default@123").GetAwaiter().GetResult();
                if (result.Succeeded) _userManager.AddToRoleAsync(user, "Admin").GetAwaiter().GetResult();
            }
            ...
            if (_userManager.FindByEmailAsync("teacher@elearning.com").Result == null)
            {
                ...
                var result = _userManager.CreateAsync(teacher_user, "Default@123").GetAwaiter().GetResult();
                if (result.Succeeded) _userManager.AddToRoleAsync(teacher_user, "Teacher").GetAwaiter().GetResult();
            }
        }
    }
}